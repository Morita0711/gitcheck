...
class TestNamingStandard(unittest.TestCase):
    ...
    @with_env(workspace="workspace", git_project="https://github.com/tinkerbell07/exercise.git")
    def test_run_good(self):
        r = self.hook_class.run(args=None)
        self.assertEqual(r, True)

    @with_env(workspace="workspace",
              git_project="https://github.com/tinkerbell07/exercise.git",
              commands=[["git", "branch", "test"]])
