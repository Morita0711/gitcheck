...
moduleName = '05-Stop_Direct_Commits'
spec = importlib.util.spec_from_file_location(moduleName, os.path.join(pre_commit_scripts, '05-Stop_Direct_Commits.py'))
...
class TestStopDirectCommits(unittest.TestCase):
